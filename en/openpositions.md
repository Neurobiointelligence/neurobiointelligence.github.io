...
<section class="content-section" style="background-color: #f9f9f9;">
  <div class="container" style="max-width: 1100px; margin: 0 auto;">
    <h2 style="font-size: 1.3rem; font-weight: bold; margin-top: 20px;">신경지능 연구실 (Neurobiological Intelligence Lab) 모집 안내</h2>       
    <p style="font-size: 1rem; margin-top: 20px; line-height: 1.7;">
      GIST 생명과학과의 신경지능 연구실은 기억, 동기, 행동의 상호작용 원리를 탐구하는 융합형 뇌과학 연구팀입니다.
      생명과학·공학·AI 분야에 걸친 협력적 연구를 통해 신경지능의 근본 원리를 밝혀내고자 합니다.
    </p>
    <h3 style="font-size: 1rem; margin-top: 30px;">주요 연구 키워드 및 기술</h3>
    ...
    <h3 style="font-size: 1rem; margin-top: 30px;">이런 분을 기다립니다</h3>
    <ul style="line-height: 1.7; font-size: 0.9rem;">
    ...
    <h3 style="font-size: 1rem; margin-top: 30px;">모집 대상</h3>
